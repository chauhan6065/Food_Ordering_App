...
def def_main():
    while True:
        print("*" * 21+ "WELCOME TO THE FOOD ORDERING APP" + "*" * 19 + "\n") 
...
def def_full_file_reader():                                                                        
    file_foods = open('E:\Food_Ordering_App\list_foods.fsd', 'r') 
    for i in file_foods: 
        list_foods.append(str(i.strip())) 
    file_foods.close()

    file_drinks = open('E:\Food_Ordering_App\list_drinks.fsd', 'r') 
    for i in file_drinks:
        list_drinks.append(str(i.strip()))
    file_drinks.close()

    file_services = open('E:\Food_Ordering_App\list_services.fsd', 'r') 
